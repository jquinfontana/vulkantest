...
//estructura con los indices de las queues
...
//estructura con las propiedades de la swapchain
...
private:
...
#endif
        //guardo el primer dispositivo que me sirve (en vez de eso puedo discriminar entre los que hay, para ver cual prefiero)
        for (const auto& device : devices) {
    ...
    bool checkDeviceExtensionSupport(VkPhysicalDevice device) {
        ...
        //imprimo extensiones del dispositivo
#ifdef PRINT_STATUS
        std::cout << "available divice extensions:\n";
        for (const auto& extension : availableExtensions) {
            std::cout << '\t' << extension.extensionName << '\n';
        }
        //imprimo las requeridas
        std::cout << "\nextenciones del dispositivo requeridas:\n";
    ...
    void createSwapChain() {
        ...
        createInfo.preTransform = swapChainSupport.capabilities.currentTransform; //cambiar parametro para aplicar transformacion a imagenes
        createInfo.compositeAlpha = VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; //cambiar parametro para usar alfa entre ventanas ???
    ...
    void createGraphicsPipeline() {
        //leemos y envolvemos los spv de los shaders
        auto vertShaderCode = readFile("shaders/vert.spv");
        auto fragShaderCode = readFile("shaders/frag.spv");
        VkShaderModule vertShaderModule = createShaderModule(vertShaderCode);
        VkShaderModule fragShaderModule = createShaderModule(fragShaderCode);

        //indicamos informacion como punto de entrada del shader o su tipo
        ...
        //indicamos descriptores de atributo para vertices (formato de los datos a enviar a gpu)
        ...
        //indicamos formato de geometria que s eva a tomar a partir de los vertices, en este caso cada 3 vertices corresponde a un triangulo
        ...
        //indicamos informacion importante sobre el resterizado, como wireframe mode, backface culling, ancho de lineas, etc
        ...
        //configuro opciones de combinacion de colores
        ...
        //ejemplo de configuracion que implementa alfa blending
        /*
        ...
        */
        ...
        //configuracion de color globar, creo que puede sobreescribir parametros de colorblendattachment
        ...
        //establecemos el view port y la scissors como cosas dinamicas (pueden cambiar en la ejecucion de la app)
    ...
    void createVertexBuffer() {
        ...
        //asocio datos con la memoria alocada
        vkBindBufferMemory(device, vertexBuffer, vertexBufferMemory, 0);
        //mapeo memoria de cpu a gpu
        void* data;
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
        //seteo el tamaño de las imagenes, en este caso que concuerden con el tamaño de la ventana, para eso pido al glfw que me de el tamaño pero en un sistema de coordenadas distino
        //(creo que en pixeles, porque vulkan trabaja con pixeles, eso significa que las constantes WIDTH Y HEIGTH etan en coordenadas de pantalla)
        //revisar bien el significado de cada cosa y si el resultado es coherente
    ...
    void objectToVkGeometryKHR(VkBuffer buffer) {
        // BLAS builder requires raw device addresses.
        VkDeviceAddress vertexAddress = getBufferDeviceAddress(device, buffer);
        ...
        triangles.maxVertex = 3 - 1;

        // Identify the above data as containing opaque triangles.
        VkAccelerationStructureGeometryKHR asGeom{ VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR };
        asGeom.geometryType = VK_GEOMETRY_TYPE_TRIANGLES_KHR;
        asGeom.flags = VK_GEOMETRY_OPAQUE_BIT_KHR; //for anyhit
        ...
        vkGetAccelerationStructureBuildSizesKHR(device, VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR, &buildInfo,
            &offset.primitiveCount, &sizeInfo);
    ...
    void mainLoop() {
        std::cout << std::endl << "FPS: " << std::endl;
        int iteraciones = 0;
